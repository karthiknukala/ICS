...
typedef std::unordered_set<unsigned int> FormulaIdSet;
typedef std::unordered_map<unsigned int, std::vector<unsigned int> > FormulaIdMapping;
typedef std::unordered_map<int, int> ICSAtomToFormulaId;
...
class ICSInterface {
 ...
 public:
  ...
  std::vector<unsigned int> & get_associated_formulas(unsigned int f_idx) { return associated_formulas[f_idx]; }
