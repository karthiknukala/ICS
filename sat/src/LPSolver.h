...
protected:
	...
	bool deleted;
  friend std::ostream & operator << ( std::ostream & target, LPClause & c);
...
inline std::ostream & operator << (std::ostream & target, LPClause & c) {
...
private:
  ...
  std::unordered_set<unsigned int> relevant_atoms;
...
public:
	...
	void compute_relevant_atoms(LPFormulaId f);
	...
	bool fast_assign_formula(LPFormulaId target, LPFormulaId value, int antecedent);
...
protected:
  ...
  void dump_implication_graph(std::ostream & target, LPIdList ** implication_graph);
...
public:
	...
	// Pretty printing
	//
  void dump_internal_info(std::ostream & target);
  void dump_to_check_vector(std::ostream & target);
  void dump_atomic_formula_values(std::ostream & target, LPFormulaId f);
	void dump_ics_state() { ics_interface.dump_current_state(); }
  void dump_clauses(std::ostream & target);
  void dump_clause(std::ostream & target, LPClause & clause);
	//
...
inline std::ostream & operator << (std::ostream & target, LPSolver & s) {
