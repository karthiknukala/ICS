...
int icsat_explain_is_empty() {
  ...
  CAMLreturn(Bool_val(caml_callback(*closure, Val_unit)));
}
...
int icsat_is_explained() { 
  ...
  return(Bool_val(caml_callback(*closure, Val_unit)));
}
...
int icsat_explain_pop() {
  ...
  CAMLreturn(Int_val(caml_callback(*closure, Val_unit)));
}
...
int icsat_is_nil(value x1) {
  ...
  CAMLreturn(Bool_val(caml_callback(*closure, x1)));
}
...
int icsat_length(value x1) {
  ...
  CAMLreturn(Int_val(caml_callback(*closure, x1)));
}
...
value icsat_tail(value x1) {
  ...
  CAMLreturn((value)(caml_callback(*closure, x1)));
}
...
int icsat_assert(int x1) {
  ...
  return(Int_val(caml_callback(*closure, Val_int(x1))));
}
...
int icsat_is_connected(int x1, int x2) {
  ...
  return(Bool_val(caml_callback2(*closure, Val_int(x1), Val_int(x2))));
}

void icsat_atom_pp(int x1) {
  static const value * closure = NULL;
  if (closure == NULL) { closure = caml_named_value("prop_atom_pp"); }
  caml_callback(*closure, Val_int(x1));
}
...
extern LPFormulaId sat_mk_var(const char * var);
